        ...
        <div className="app-shell relative">
          <div className="flex h-[60px] items-center justify-between gap-3 md:h-[72px]">
            <div className="flex min-w-0 items-center gap-3 md:gap-4">
              <div
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg p-1.5 backdrop-blur-sm md:h-11 md:w-11 md:p-1.5"
                style={{
              ...
              <div className="min-w-0">
                ...
                <h1 className="truncate text-lg font-semibold tracking-[-0.01em] text-text-inverse md:text-xl">
                  Gestão de Contratos
                </h1>
              </div>
            </div>
            ...
            <div className="hidden md:block">
              ...
              >
                ...
                />
                <span className="tnum">{buildDate}</span>
              </div>
            </div>
          </div>
        </div>
